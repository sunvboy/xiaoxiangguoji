 <form class="w-full mx-auto bg-white shadow-lg rounded-bl-[10px] rounded-br-[10px] h-screen overflow-hidden" action="{{!empty($action == 'create') ? route('category_products.store') : route('category_products.update',['id' => $detail->id])}}" method="post" enctype="multipart/form-data">
         ...
         <div class="grid grid-cols-12 gap-[30px]">
             ...
             <div class="col-span-4 space-y-5">
                 <div class="space-y-1">
                     ...
                     <?php echo Form::select('parentid', $htmlCatalogue, !empty($detail->parentid) ? $detail->parentid : (!empty(old('parentid')) ? old('parentid') : ''), ['class' => 'form-control', 'data-placeholder' => "Select your favorite actors"]); ?>
                 </div>

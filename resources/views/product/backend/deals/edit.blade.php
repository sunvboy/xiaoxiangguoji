...
<div class="content">
    ...
    <form class="grid grid-cols-12 gap-6 mt-5" id="submitFormDeals" role="form" action="{{route('product_deals.update',['id' => $detail->id])}}" method="post" enctype="multipart/form-data">

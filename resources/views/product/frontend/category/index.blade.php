...
<div class="ps-categogy main-category-product main-category-product-list pb-120 bg-gray" id="scrollTop">
    ...
    <div class="container">
        ...
        <div class="top-category-product">
            ...
            <h1 class="title-primary-1">{{$detail->title}}</h1>
                ...
                <div class="col-md-3 col-sm-6 col-12">
                    ...
                    <div class="item">
                        ...
                        <div class="nav-img">
                            ...
                            <p class="desc-2">{{$item->countProduct->count()}} sản phẩm</p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <select name="attr[]" class="js_select_attr filter">
                                    ...
                                    <option value="{{$val['id']}}" data-title="{{$val['title']}}" data-keyword="{{$val['keyword']}}">{{$val['title']}}</option>

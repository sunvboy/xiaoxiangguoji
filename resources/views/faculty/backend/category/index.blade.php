...
<div class="content">
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class=" col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2 justify-between">
            ...
            @can('faculty_categories_create')
            <a href="{{route('faculty_categories.create')}}" class="btn btn-primary shadow-md mr-2">Thêm mới</a>
            @endcan
        </div>
        <!-- BEGIN: Data List -->
                    ...
                    <tr class="odd " id="post-<?php echo $v->id; ?>">
                        ...
                        <td class="whitespace-nowrap">
                            <a href="{{route('articles.index',['catalogueid'=>$v->id])}}">
                                ...
                                ({{!empty($v->faculties)?count($v->faculties):0}})</a>
                        ...
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                                ...
                                @can('faculty_categories_edit')
                                <a class="flex items-center mr-3" href="{{ route('faculty_categories.edit',['id'=>$v->id]) }}">
                                    <i data-lucide="check-square" class="w-4 h-4 mr-1"></i>
                                    Edit
                                </a>
                                @endcan
                                @can('faculty_categories_destroy')

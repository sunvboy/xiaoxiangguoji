    ...
    <div>
        ...
        <div class="flex justify-between items-center mt-2">
            <div class="flex flex-1 items-center space-x-2 justify-end">
                ...
                @can('deals_create')
                <a href="{{route('deals.website.create')}}" class="text-white space-x-1 flex items-center bg-primary font-medium rounded-lg text-[13px] w-full sm:w-auto px-5 py-2.5 text-center ">

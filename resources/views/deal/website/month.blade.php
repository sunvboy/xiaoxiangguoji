...
@section('title')
<title>Danh sách HĐ mới khởi tạo trong tháng</title>
@endsection
@section('breadcrumb')
<?php
$array = array(
    [
        "title" => "Danh sách HĐ mới khởi tạo trong tháng",
...
<div class="px-4 py-2 space-y-2">
    ...
    <div id="data_product">
        @include('deal.backend.data',['permissionCheckedIndex' => $permissionCheckedIndex,'data'=>$data,'type' => 'month'])
    </div>
...
@endsection
@include('deal.script.index',['type' => 'month'])
       ...
       <table class="table table-report -mt-2">
           ...
           <tbody id="table_data" role="alert" aria-live="polite" aria-relevant="all">
               ...
               <tr class="odd " id="post-<?php echo $v->id; ?>">
                   ...
                   <td>
                       <a class="text-primary font-bold" href="{{ route('receipt_vouchers.edit',['id'=>$v->id]) }}">
                           {{$v->code}}
                       </a>
                   </td>
                   <td>
                       <span class="text-primary">{{!empty($v->receipt_groups) ? $v->receipt_groups->title:''}}</span>
                   </td>
                   <td>
                   ...
                   <td class="table-report__action w-56 ">
                       <div class="flex justify-center items-center">
                           @can('receipt_vouchers_edit')
                           <a class="flex items-center mr-3" href="{{ route('receipt_vouchers.edit',['id'=>$v->id]) }}">

 <form class="w-full mx-auto bg-white shadow-lg rounded-bl-[10px] rounded-br-[10px] h-screen overflow-hidden" action="{{!empty($action == 'create') ? route('tags.store') : route('tags.update',['id' => $detail->id])}}" method="post" enctype="multipart/form-data">

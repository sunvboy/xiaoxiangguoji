...
@section('title')
<title>Thêm mới nhóm đề thi</title>
@endsection
<!--START: breadcrumb -->
@section('breadcrumb')
<?php
...
<div class="content">
    <div class=" flex items-center mt-8">
        <h1 class="text-lg font-medium mr-auto">
            Thêm mới nhóm đề thi
        </h1>
    </div>
    <form class="grid grid-cols-12 gap-6 mt-5" role="form" action="{{route('quiz_categories.store')}}" method="post" enctype="multipart/form-data">

...
?>
<footer class="pt-24 wow fadeInUp mt-10" style="background: url(http://tailwind.tamphat.edu.vn//theme/library/img/img_2/bg-footer.jpg);background-repeat: no-repeat;background-size: cover;">

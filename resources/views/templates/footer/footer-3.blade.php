...
?>
<footer class="pt-7 md:pt-11 wow fadeInUp mt-10 bg-black">
                ...
                <div class="item">
                    ...
                    <div class="social-footer mt-[15px]">
                        ...
                        <ul class="flex flex-wrap">
                            <li><a href="{{$fcSystem['social_facebook']}}" target="_blank" class="text-[#8b8e96] inline-block w-[30px] h-[30px] text-center leading-[30px] mr-[5px] border rounded-full hover:text-red-600"><i class="fa-brands fa-facebook-f"></i></a></li>
                            <li><a href="{{$fcSystem['social_instagram']}}" target="_blank" class="text-[#8b8e96] inline-block w-[30px] h-[30px] text-center leading-[30px] mr-[5px] border rounded-full hover:text-red-600"><i class="fa-brands fa-instagram"></i></a></li>
                            <li><a href="{{$fcSystem['social_google_plus']}}" target="_blank" class="text-[#8b8e96] inline-block w-[30px] h-[30px] text-center leading-[30px] mr-[5px] border rounded-full hover:text-red-600"><i class="fa-brands fa-google"></i></a></li>
                            <li><a href="{{$fcSystem['social_youtube']}}" target="_blank" class="text-[#8b8e96] inline-block w-[30px] h-[30px] text-center leading-[30px] mr-[5px] border rounded-full hover:text-red-600"><i class="fa-brands fa-youtube"></i></a></li>
                        </ul>
                    </div>
                </div>
            </div>
            <?php echo getHtmlMenusFooter($menu_footer, array(
                'class' => 'lg:w-1/5 md:w-1/5 sm:w-full w-full px-3',

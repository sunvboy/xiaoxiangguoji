  ...
  @section('content')
      <main>
          ...
          <section class="breadcrumb-area tp-breadcrumb-bg breadcrumb-wrap" data-background="{{asset($fcSystem['banner_8'])}}">
              <div class="container">
                  <div class="row">
                      <div class="col-12">
                      ...
                      <div class="col-lg-6">
                          <div class="tp-contact-wrapper mb-60">
                              <div class="tp-contact-inner">
                                  <h4 class="tp-contact-inner-title">{{$page->title}}</h4>
                              ...
                              <div class="tp-contact-wrap">
                                  <div class="row">
                                      <div class="col-xl-4 col-lg-6 col-md-6">
                                          ...
                                          <div class="tp-contact-item">
                                              <span>Địa chỉ:</span>
                                              <a href="javascript:void(0)">{{$fcSystem['contact_address']}}</a>
                                          </div>
                                      </div>
                                      <div class="col-xl-8 col-lg-6 col-md-6">
                                          <div class="tp-contact-item ml-15">
                                              <span>Email</span>
                                              <a href="mailto:{{$fcSystem['contact_address']}}"><span class="__cf_email__">{{$fcSystem['contact_email']}}</span></a>
                                          </div>

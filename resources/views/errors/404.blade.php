    ...
    <div class="container">
        ...
        <div class="error-page flex flex-col lg:flex-row items-center justify-center h-screen text-center lg:text-left">
            <div class="-intro-x lg:mr-20">
                <img alt="Rocketman - HTML Admin Template" class="h-48 lg:h-auto" src="{{ asset('backend/images/error-illustration.svg')}}">
            </div>
            <div class="text-white mt-10 lg:mt-0">
                ...
                <a href="{{url('')}}" class="intro-x btn py-3 px-4 text-white border-white dark:border-darkmode-400 dark:text-slate-200 mt-10">Back
                    to Home</a>
            </div>
        </div>
        <!-- END: Error Page -->

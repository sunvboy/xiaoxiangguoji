...
$(document).ready(function () {
    ...
    if (typeof module !== "undefined") {
        ...
        var count = 0;
        var dataId = "";
        $(".tp_item_variable.checked").each(function (i, obj) {
    ...
    $(document).on("click", '.tp_item_variable[data-stt="0"]', function (e) {
        var stt0 = [];
        $('.tp_item_variable[data-stt="0"]').each(function (i, obj) {
            var id = parseInt($(this).attr("data-id"));
            stt0.push(id);
        });
        console.log(stt0);
    ...
    function loadDataVersion(result) {
        ...
        if (result.idStock > 0) {
            ...
            //     if (index == 0) {
            //         $(".tp_item_variable_" + arr[index] + "").addClass(
            //             "checked"
            //         );
            //     }
            // }

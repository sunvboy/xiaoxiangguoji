    ...
    function validatorNum(msg) {
        return function () {
            var value = this.getValue(),
                pass = !!(
                    CKEDITOR.dialog.validate.integer()(value) && value > 0
                );
    ...
    return {
        ...
        onShow: function () {
            ...
            var rowsInput = this.getContentElement("info", "rowCount"),
                rowsInputFlex = this.getContentElement("info", "rowCountFlex"),
        ...
        contents: [
            {
                ...
                elements: [
                    ...
                    },
                    {
                        ...
                        validate: validatorNum(lang.numRowsError),
                        setup: function (widget) {
                            this.setValue(widget.data.rowCountFlex);
                        },
                        commit: function (widget) {
                            widget.setData("rowCountFlex", this.getValue());
                        },
                    },
                ],
            },

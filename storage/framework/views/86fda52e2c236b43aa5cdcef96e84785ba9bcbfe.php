...
<div class="content">
    ...
    <form class="grid grid-cols-12 gap-6 mt-5" role="form" action="<?php echo e(route('courses.update',['id' => $detail->id])); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class=" box p-5">
                ...
                <div class="tab-content">
                    <div id="example-tab-homepage" class="tab-pane leading-relaxed active" role="tabpanel" aria-labelledby="example-homepage-tab">
                        <?php echo $__env->make('course.backend.course.form',['action' => 'update'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    ...
                    <div id="example-tab-attr" class="tab-pane leading-relaxed" role="tabpanel" aria-labelledby="example-attr-tab">
                        <?php echo $__env->make('course.backend.course.attribute',['action' => 'update'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <div id="example-tab-course" class="tab-pane leading-relaxed" role="tabpanel" aria-labelledby="example-course-tab">
                        <?php echo $__env->make('course.backend.course.course',['action' => 'update'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\chuan.local\resources\views/course/backend/course/edit.blade.php ENDPATH**/ ?>
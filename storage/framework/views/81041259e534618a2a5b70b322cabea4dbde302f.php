        ...
        <div class="ps-page__content">
            ...
            <section class="health-corner bg-white">
                <div class="section-title-2 cat">
                    <h2 class=" ps-section__title title title split-in-fade"><?php echo e($detail->title); ?></h2>
                </div>
                ...
                <div class="col-md-9 col-sm-9 col-12">
                    ...
                    <div class="item-item bg-white">
                        <div class="item-large">
                            <div class="title-tab">
                                <div class="section-title-2 cat">
                                    <h2 class=" ps-section__title title title split-in-fade"><?php echo e($item->title); ?></h2>
                                </div>
                                <div class="readmore">
                            ...
                            <?php if($k<=1): ?> <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="item">
                                    ...
                                    <div class="nav-img">
                                        ...
                                        <p class="date"><i class="fa fa-calendar-o" aria-hidden="true"></i> <?php echo e(\Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $v->created_at)->format('d/m/Y')); ?></p>
                                        <div class="desc">
                                            <?php echo $v->description; ?>
...
<?php echo $__env->make('homepage.layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/catdailoc/domains/daicatloc.nhathuocdaicatloc.vn/public_html/resources/views/article/frontend/category/children.blade.php ENDPATH**/ ?>
                ...
                <div class="col-span-2">
                    ...
                    <div class="bg-[#fff] rounded-xl p-[15px]">
                        <div class="flex items-center space-x-[12px] mb-[12px]">
                            <img alt="Thông tin người đặt" src="<?php echo e(asset('images/user.png')); ?>" class="w-[24px] h-[24px]" />
                        ...
                        <div class="flex items-center space-x-[12px] my-[12px]">
                            <img alt="Thông tin người đặt" src="<?php echo e(asset('images/pin.png')); ?>" class="w-[24px] h-[24px]" />
                    ...
                    <div class="py-[12px] font-semibold"><?php echo e(trans('index.ShippingUnit')); ?></div>
                    <div class="bg-[#fff] rounded-xl p-[15px]">
                        <?php if(!empty($getFeeShip)): ?>
                        <div class="js_box_shipping">
                            <div class="space-y-2">
                                <div class="uppercase"><?php echo e(trans('index.SHIPPINGCHANNEL',[ 'name' => $fcSystem['homepage_brandname']])); ?></div>
                    ...
                    <div class="bg-[#fff] rounded-xl p-[15px]">
                        <ul class="flex flex-col">
                            ...
                            <?php if($key != 'wallet'): ?>
                            <li class="py-[12px] px-[16px] border-b">
                                <label class="flex items-center cursor-pointer" for="<?php echo e($val->keyword); ?>" onclick="handleSelectPayment(<?php echo $val->id ?>)">
                                    <input id="<?php echo e($val->keyword); ?>" name="payment" type="radio" value="<?php echo e($val->keyword); ?>" <?php echo !empty(old('payment') && old('payment') == $val->keyword) ? 'checked' : (!empty($orderInfo['payment']) && !empty($orderInfo['payment'] == $val->keyword) ? 'checked' : (!empty($key == 0) ? 'checked' : '')) ?>>
                                    <img src="<?php echo e(!empty(config('cart')['payment_image'][$val->keyword])?config('cart')['payment_image'][$val->keyword]:''); ?>" alt="avatar" class="w-[40px] h-[40px] ml-[20px]">
                                    <span class="pl-[12px] font-semibold"><?php echo e($_payment[$val->keyword]); ?></span>
                                </label>
                ...
                <div class="col-span-1">
                    ...
                    <div class="bg-[#fff] rounded-tl-2xl rounded-tr-2xl max-w-[384px] mx-auto">
                        <div class="p-[16px]">
                            ...
                            <div class="flex justify-between items-center">
                                <h3 class="text-[16px] mb-0"><?php echo e(trans('index.TransportFee')); ?></h3>

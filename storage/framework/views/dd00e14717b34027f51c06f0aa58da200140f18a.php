...
<div class="content">
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class=" col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2 justify-between">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('quiz_categories_create')): ?>
            <a href="<?php echo e(route('quiz_categories.create')); ?>" class="btn btn-primary shadow-md mr-2">Thêm mới</a>
            <?php endif; ?>
        </div>
        <!-- BEGIN: Data List -->
                    ...
                    <tr class="odd " id="post-<?php echo $v->id; ?>">
                        ...
                        <td class="whitespace-nowrap">
                            <a href="<?php echo e(route('articles.index',['catalogueid'=>$v->id])); ?>">
                                ...
                                (<?php echo e(!empty($v->quizzes)?count($v->quizzes):0); ?>)</a>
                        ...
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('quiz_categories_edit')): ?>
                                <a class="flex items-center mr-3" href="<?php echo e(route('quiz_categories.edit',['id'=>$v->id])); ?>">
                                    <i data-lucide="check-square" class="w-4 h-4 mr-1"></i>
                                    Edit
                                </a>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('quiz_categories_destroy')): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\chuan.local\resources\views/quiz/backend/category/index.blade.php ENDPATH**/ ?>
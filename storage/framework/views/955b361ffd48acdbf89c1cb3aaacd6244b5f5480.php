        ...
        <div class="ps-page__content">
                            ...
                            <div class="ps-product__info">
                                ...
                                <div class="ps-product__desc">
                                    <ul class="ps-product__list">
                                        <?php $__currentLoopData = $descriptions['title']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if(!empty($descriptions['content'][$key])): ?>
                                        <li>
                                            <span class="span-1"><?php echo e($item); ?></span>
                                            <span class="span-2"><?php echo e(!empty($descriptions['content'])?$descriptions['content'][$key]:''); ?></span>
                                        </li>
                                        <?php endif; ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </ul>
            ...
            <section class="ps-section--featured viewed-products bg-white">
                ...
                <div class="section-title-2">
                    <h2 class=" ps-section__title title title split-in-fade"><i class="fa fa-plus-circle" aria-hidden="true"></i> Sản phẩm liên quan</h2>
                </div>
            ...
            <div class="ps-widget__content ps-widget__category question-modul bg-white">
                <div class="section-title-2">
                    <h2 class=" ps-section__title title title split-in-fade"><i class="fa fa-plus-circle" aria-hidden="true"></i>Câu hỏi thường gặp</h2>
                </div>

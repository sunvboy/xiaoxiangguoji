...
<div class="read_list space-y-5">
    ...
    <div class="flex justify-between space-x-5">
        <div class="flex-1 read-title-first-<?php echo e($v->id); ?>">
            <?php if($v->description == 'title'): ?>
            <h3 class="font-bold read_title_<?php echo e($v->id); ?> read_title"><?php echo e($v->title); ?></h3>
            <?php else: ?>
            <div class="flex items-center text-danger font-bold  read_input_<?php echo e($v->id); ?> read_input" data-text="<?php echo e($v->title); ?>">
                <?php
        ...
        <div>
            <div class="flex items-center space-x-2 read_action">
                <a class="flex items-center mr-3 read_edit" data-id='<?php echo e($v->id); ?>' data-type='<?php echo e($v->description); ?>' href="javascript:void(0)">
                    <i data-lucide="edit" class="w-4 h-4 mr-1"></i>
                    Edit
                </a>
                <a class="flex items-center mr-3 text-danger read_delete" data-id='<?php echo e($v->id); ?>' data-type='<?php echo e($v->description); ?>' href="javascript:void(0)">
                    <i data-lucide="trash-2" class="w-4 h-4 mr-1"></i>
                    Xóa
                </a>
            </div>
            <a class="flex items-center mr-3 hidden text-success read_save" data-id='<?php echo e($v->id); ?>' href="javascript:void(0)">
...
?>
            <div class="preview box p-5">
                ...
                <div class="input-group mt-2">
                    ...
                    <?php echo Form::text('options[' . $order . '][]', $v->title, ['class' => 'form-control w-full']); ?>
...
<?php $__env->stopPush(); ?><?php /**PATH D:\xampp\htdocs\chuan.local\resources\views/quiz/backend/question/common/read.blade.php ENDPATH**/ ?>
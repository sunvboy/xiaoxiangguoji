...
<div class="content">
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class=" col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2 justify-between">
            <?php echo $__env->make('components.search',['module'=>$module,'htmlOption' => $htmlOption], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('faculties_create')): ?>
            <a href="<?php echo e(route('faculties.create')); ?>" class="btn btn-primary shadow-md mr-2">Thêm mới</a>
            <?php endif; ?>
        </div>
        <!-- BEGIN: Data List -->
        <div class=" col-span-12 overflow-auto lg:overflow-visible">
            <table class="table table-report -mt-2">
                <thead>
                    <tr>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('faculties_destroy')): ?>
                        <th style="width:40px;">
                ...
                <tbody id="table_data" role="alert" aria-live="polite" aria-relevant="all">
                    ...
                    <tr class="odd " id="post-<?php echo $v->id; ?>">
                        ...
                        <td class="whitespace-nowrap">
                            <?php echo e($v->faculty_categories->title); ?>
                        ...
                        <td class="w-40">
                            <div class="form-check form-switch">
                                <input <?php echo ($v->ishome == 1) ? 'checked=""' : ''; ?> class="form-check-input publish-ajax" type="checkbox" data-module="<?php echo e($module); ?>" data-id="<?php echo $v->id; ?>" data-title="ishome" id="ishome-<?php echo $v->id; ?>">
                            </div>
                        </td>
                        <td class="table-report__action w-56 ">
                            <div class="flex justify-center items-center">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('faculties_edit')): ?>
                                <a class="flex items-center mr-3" href="<?php echo e(route('faculties.edit',['id'=>$v->id])); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\chuan.local\resources\views/faculty/backend/faculty/index.blade.php ENDPATH**/ ?>
...
<div class="content">
    ...
    <div class=" grid grid-cols-12 gap-2 justify-between mt-5 mb-5">
        <form class="grid grid-cols-12 gap-6 mt-5 hidden" role="form" action="<?php echo e(route('products.import')); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="mt-5">
...
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/catdailoc/domains/daicatloc.nhathuocdaicatloc.vn/public_html/resources/views/product/backend/product/index.blade.php ENDPATH**/ ?>
                            ...
                            <div class="nav-form">
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <span class="span-2"><?php echo e(!empty($detail->birthday) ? \Carbon\Carbon::createFromFormat('Y-m-d', $detail->birthday)->format('d/m/Y') : ''); ?></span>
                                    </li>
                                    <li>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('homepage.layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/catdailoc/domains/daicatloc.nhathuocdaicatloc.vn/public_html/resources/views/customer/frontend/manager/information.blade.php ENDPATH**/ ?>
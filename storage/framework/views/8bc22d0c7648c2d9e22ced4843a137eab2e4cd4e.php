...
<div class="content">
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class=" col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2 justify-between">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('courses_create')): ?>
            <a href="<?php echo e(route('courses.create')); ?>" class="btn btn-primary shadow-md mr-2">Thêm mới</a>
            <?php endif; ?>
        </div>
        <!-- BEGIN: Data List -->
        <div class=" col-span-12 overflow-auto lg:overflow-visible">
            <table class="table table-report -mt-2">
                <thead>
                    <tr>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('courses_destroy')): ?>
                        <th style="width:40px;">
                ...
                <tbody id="table_data" role="alert" aria-live="polite" aria-relevant="all">
                    ...
                    <tr class="odd " id="post-<?php echo $v->id; ?>">
                        ...
                        <td class="whitespace-nowrap">
                            ...
                            <a class="text-danger" href="<?php echo e(route('courses.index',['catalogueid' => $c->id])); ?>"><?php echo !empty($kc == 0) ? '' : ',' ?><?php echo e($c->title); ?></a><br>
                        ...
                        <td class="table-report__action w-56 ">
                            <div class="flex justify-center items-center">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('courses_edit')): ?>
                                <a class="flex items-center mr-3" href="<?php echo e(route('courses.edit',['id'=>$v->id])); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\chuan.local\resources\views/course/backend/course/index.blade.php ENDPATH**/ ?>
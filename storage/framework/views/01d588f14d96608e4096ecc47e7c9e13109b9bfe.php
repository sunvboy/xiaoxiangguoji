...
<div class="ps-categogy main-category-product main-category-product-list pb-120 bg-gray" id="scrollTop">
    <div class="container">
        <ul class="ps-breadcrumb">
            ...
            <li class="ps-breadcrumb__item active" aria-current="page"><a href="<?php echo e(route('homepage.search',['keyword' => request()->get('keyword')])); ?>">Kết quả tìm kiếm</a></li>
        </ul>
...
<?php echo $__env->make('product.frontend.category.script',['module' => 'search'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('homepage.layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/catdailoc/domains/daicatloc.nhathuocdaicatloc.vn/public_html/resources/views/product/frontend/search/index.blade.php ENDPATH**/ ?>
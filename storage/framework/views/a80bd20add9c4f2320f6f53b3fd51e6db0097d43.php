...
<div class="content">
    ...
    <form class="grid grid-cols-12 gap-6 mt-5" role="form" action="<?php echo e(route('question_option_users.update',['id' => $detail->id])); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="space-y-2">
                            ...
                            ?>
                                        <div class="preview box p-5">
                                            <div>
                                                <div class="mt-2">
                                                    <span class="font-bold"><?php echo e($i); ?>.</span> <?php echo !empty($item) ? $item[0]['description'] : ""; ?>
                                            ...
                                            <div class="input-group mt-2 ">
                                                <label class="cursor-pointer p-2 space-x-2 flex flex-wrap" onClick="handleQuestionOption('<?php echo $v['question_id'] . '-' . $key ?>',<?php echo e($v['id']); ?>,<?php echo e($i); ?>)">
                            ...
                            <div>
                                ...
                                <div for="file" class="p-2 flex items-center space-x-2 uploadFile cursor-not-allowed w-full h-[45px] border border-gray-200 mb-[15px] leading-[45px] pl-[10px] bg-white">
                                    <div>
                                        ...
                                        <audio id="songDA<?php echo $exp['id']; ?>" class="w-full max-w-md mx-auto hidden songDA" controls>
                                ...
                                <div class="flex justify-between space-x-5">
                                    <div class="flex-1">
                                        ...
                                        <div class="flex items-center flex-wrap">
                                            ...
                                            ?>
                                            <span class="font-bold"><?php echo $i ?>.</span> <?php echo $str; ?>
                                ...
                                <div class="mt-3 space-y-3">
                                    ...
                                    ?>
                                                <div class="preview box p-5">
                                                    ...
                                                    ?>
                                                    <div class="input-group mt-2 ">
                                                        <label class="cursor-pointer flex flex-wrap p-2 space-x-2" onClick="handleQuestionOption('<?php echo $v['question_id'] . '-' . $key ?>',<?php echo e($v['id']); ?>,<?php echo e($i); ?>)">
                                                            <input disabled <?php if (!empty($questionOptionsSuccess[$exp['id']][$key]) && $questionOptionsSuccess[$exp['id']][$key] == $v['id']) { ?>checked<?php } ?> type="radio">
                                                            <span class="<?php echo $class ?> flex flex-wrap">
                                                                <?php echo e($v['characters']); ?>.&nbsp;<?php echo $v['title']; ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\chuan.local\resources\views/quiz/backend/customer/edit.blade.php ENDPATH**/ ?>
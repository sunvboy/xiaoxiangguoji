                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                        <div class="order-medicine-right">
                            ...
                            <div class="item">
                                <h3 class="title-3">Quy trình tư vấn tại <?php echo e($fcSystem['homepage_brandname']); ?></h3>
                                <div class="list-list">
                                    <ul>
                                        <?php $__currentLoopData = $quytrinh; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li><span><?php echo e($key+1); ?></span><?php echo e($item); ?></li>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </ul>
                                    <?php if(!empty( $fcSystem['title_9'])): ?>
                                    <div class="note">
                ...
                <div class="product-add">
                    <div class="product-add-list">
                        ...
                        <div class="item">
                            ...
                            <div class="add">
                                <button class="js_handleAddProduct" data-id="<?php echo e($item->id); ?>" data-image="<?php echo e(asset($item->image)); ?>" data-title="<?php echo e($item->title); ?>">Thêm</button>
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php endif; ?>
                    ...
                    <form action="" id="form-header-login-2">
                        ...
                        <div class="note">
                            <ul>
                                ...
                                <li class="li-2">
                                    <a href="<?php echo e(route('customer.reset-password')); ?>" target="_blank">Quên mật khẩu?</a>
                                </li>
                            </ul>
                        </div>
                        <button type="submit" class="js_submit_login_2">Đăng nhập</button>
                        <p class="note-2">Bạn chưa có tài khoản? <a href="<?php echo e(route('customer.register')); ?>" target="_blank">Đăng ký ngay</a></p>
                    </form>
                </div>
            </div>
        </div>
...
<script>
    $(document).on('click', '.js_submit', function(e) {
        ...
        $.ajax({
            ...
            url: "<?php echo e(route('pageF.onlineStore')); ?>",
            type: "POST",
            dataType: "JSON",
            data: {
                //hóa đơn
...
<?php echo $__env->make('homepage.layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/catdailoc/domains/daicatloc.nhathuocdaicatloc.vn/public_html/resources/views/page/frontend/online.blade.php ENDPATH**/ ?>
...
<main class="pt-[40px] md:pt-16 pb-[80px] md:pb-[150px]">
    <div class="container px-4 md:px-0">
        <?php if(isset($cart['cart']) && is_array($cart['cart']) && count($cart['cart']) > 0 ): ?>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="space-y-3 col-span-2 bg-[#fff] p-[16px] rounded-2xl">
                ...
                <div class="cart_item flex gap-5 items-center border-b pb-3">
                    ...
                    <div class="flex items-center w-[110px] font-bold">
                        Số lượng
                    </div>
                ...
                <div class="cart_item cart-<?php echo e($k); ?> flex gap-5 items-center border-b pb-3">
                    <div class="w-[390px] flex gap-5 items-center">
                        ...
                        <div class="flex flex-col flex-1">
                            ...
                            <span><?php echo e($title_version); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center w-[110px]">

...
<div class="content">
    ...
    <form class="grid grid-cols-12 gap-6 mt-5" role="form" action="<?php echo e(route('questions.update',['id' => $detail->id])); ?>" method="post" enctype="multipart/form-data">
        <div class=" col-span-12 lg:col-span-12">
            <div class="box p-5">
                ...
                <?php if ($detail->type == 1) { ?>
                    <?php echo $__env->make('quiz.backend.question.update.experience', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php } ?>
                ...
                <?php if ($detail->type == 4) { ?>
                    <div class="mt-3 box-rewrite space-y-5">
                        <?php echo $__env->make('quiz.backend.question.update.rewrite', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                <?php } ?>
                <?php if ($detail->type == 5) { ?>
                    <div class="mt-3 box-read space-y-5">
                        <?php echo $__env->make('quiz.backend.question.update.read', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                <?php } ?>
                <div class="mt-3">
                    <input class="" name="isTrueValue" value="" type="hidden">
                    <input class="" name="type" value="<?php echo e($detail->type); ?>" type="hidden">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\chuan.local\resources\views/quiz/backend/question/edit.blade.php ENDPATH**/ ?>
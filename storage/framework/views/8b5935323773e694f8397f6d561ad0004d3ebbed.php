<div class="rewrite_list space-y-5">
    <?php if(!empty($detail->question_options)): ?>
    <?php $__currentLoopData = $detail->question_options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="flex justify-between space-x-5">
        <div class="flex-1 rewrite-title-first-<?php echo e($v->id); ?>">
            <?php if($v->description == 'title'): ?>
            <h3 class="font-bold rewrite_title_<?php echo e($v->id); ?> rewrite_title"><?php echo e($v->title); ?></h3>
            <?php else: ?>
            <div class="flex items-center text-danger font-bold  rewrite_input_<?php echo e($v->id); ?> rewrite_input" data-text="<?php echo e($v->title); ?>">
                <?php
        ...
        <div>
            <div class="flex items-center space-x-2 rewrite_action">
                <a class="flex items-center mr-3 rewrite_edit" data-id='<?php echo e($v->id); ?>' data-type='<?php echo e($v->description); ?>' href="javascript:void(0)">
                    <i data-lucide="edit" class="w-4 h-4 mr-1"></i>
                    Edit
                </a>
                <a class="flex items-center mr-3 text-danger rewrite_delete" data-id='<?php echo e($v->id); ?>' data-type='<?php echo e($v->description); ?>' href="javascript:void(0)">
                    <i data-lucide="trash-2" class="w-4 h-4 mr-1"></i>
                    Xóa
                </a>
            </div>
            <a class="flex items-center mr-3 hidden text-success rewrite_save" data-id='<?php echo e($v->id); ?>' href="javascript:void(0)">
...
<?php $__env->stopPush(); ?><?php /**PATH D:\xampp\htdocs\chuan.local\resources\views/quiz/backend/question/common/rewrite.blade.php ENDPATH**/ ?>
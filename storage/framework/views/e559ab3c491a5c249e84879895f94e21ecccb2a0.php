   <div class="aside-information  bg-white">
       ...
       <div class="list-information">
           <ul>
               ...
               <li>
                   <a href="<?php echo e(route('customer.orderOnline')); ?>" class="menu_item_auth"><i class="fa fa-cubes" aria-hidden="true"></i>Đặt thuốc online<i class="fa fa-angle-right" aria-hidden="true"></i></a>
               </li>
               <li>
   ...
   </script><?php /**PATH /home/catdailoc/domains/daicatloc.nhathuocdaicatloc.vn/public_html/resources/views/customer/frontend/auth/common/sidebar.blade.php ENDPATH**/ ?>
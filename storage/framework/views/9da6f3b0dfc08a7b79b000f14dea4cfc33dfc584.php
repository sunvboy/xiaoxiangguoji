...
<div class="py-12 transition duration-150 ease-in-out z-10 fixed top-0 right-0 bottom-0 left-0 " id="modal" style="background:#0000007a;display: none;z-index: 99999999;">
    <div role="alert" class="container mx-auto w-11/12 md:w-2/3 !max-w-3xl">
        <div class="relative py-8 px-5  bg-white shadow-md rounded border border-gray-400">
            ...
            <h2 class="text-gray-800 font-lg font-bold tracking-normal leading-tight mb-4 text-lg pr-0 md:pr-[50px]"><?php echo e($detail->title); ?></h2>
            <div class="modal-body relative pt-[15px] border-t border-[#e5e5e5]">
                <form id="form-comment">
                    ...
                    <div class="write-review__info flex-1 flex items-end justify-between mt-3">
                        <input value="" type="text" name="fullname" placeholder="<?php echo e(trans('index.Fullname')); ?>" class="w-[49%] h-9 leading-9 cursor-pointer rounded flex justify-center items-center outline-none focus:outline-none hover:outline-none border border-[#eeeeee] px-4 py-[6px] " required>
                        <input value="" type="text" name="phone" placeholder="<?php echo e(trans('index.Phone')); ?>" class="w-[49%] h-9 leading-9 cursor-pointer rounded flex justify-center items-center outline-none focus:outline-none hover:outline-none border border-[#eeeeee] px-4 py-[6px] ">
                    </div>
                    ...
                    <div class="flex-1 flex items-end justify-between m-0 ">
                        ...
                        <button type="submit" class="write-review__button write-review__button--submit w-1/2 bg-red-600 ml-4  py-3 leading-9 cursor-pointer rounded flex items-center justify-center text-white border-red-600 border"><span><?php echo e(trans('index.guidanhgia')); ?></span>
                        </button>
                    </div>
                </form>
            </div>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/catdailoc/domains/daicatloc.nhathuocdaicatloc.vn/public_html/resources/views/product/frontend/product/comment/index.blade.php ENDPATH**/ ?>
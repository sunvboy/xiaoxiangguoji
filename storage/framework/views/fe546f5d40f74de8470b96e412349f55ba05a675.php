       ...
       <div class="breadcrumb py-[10px] bg-gray-100">
           <div class="container mx-auto px-3">
               <ul class="flex flex-wrap">
                   ...
                   <li class="pr-[5px]">Kết quả: <?php echo e($detail->title); ?></li>
               </ul>
           </div>
       </div>
                           ...
                           <table class="w-full mt-[20px] flex-1 md:h-full">
                               <tr>
                                   <td class="border border-gray-200 p-[10px] text-center">
                                       <span class="bold-1 pr-[15px]">Tông số câu hỏi:</span> <?php echo e($count); ?> câu
                                   </td>
                               </tr>
                               <tr>
                                   <td class="border border-gray-200 p-[10px] text-center">
                               ...
                               <tr>
                                   <td class="border border-gray-200 p-[10px] text-center">
                                       <span class="bold-1 pr-[15px]">Thời gian làm bài:</span> <?php echo e($detail->time); ?> phút
                                   </td>
                               </tr>
                               <tr>
                                   <td class="border border-gray-200 p-[10px] text-center">
                                       <span class="bold-1 pr-[15px]">Số lần làm lại :</span> <?php echo e($NumberOfReworks); ?>

                                   </td>
                               </tr>
                               <tr>
                                   <td class="border border-gray-200 p-[10px] text-center">
                                       <a href="<?php echo e(route('quizzes.frontend.answer',['slug' => $detail->slug,'id' => $success->id])); ?>" class="inline-block transition-all py-[8px] rounded-[5px] px-[25px] bg-color_primary text-white border border-color_primary hover:bg-white hover:text-color_primary bold-1 uppercase mr-[10px]">
                                           Xem đáp án
                                       </a>
                                       <a href="<?php echo e(route('quizzes.frontend.quiz',['slug' => $detail->slug])); ?>" class="inline-block transition-all py-[8px] rounded-[5px] px-[25px] bg-color_second border border-color_second hover:bg-color_primary hover:border-color_primary hover:text-white bold-1 uppercase">
                                           làm lại<i></i>
                                       </a>
                                   </td>
                               </tr>
                           ...
                           <table class="w-full mt-[20px] flex-1 md:h-full">
                               <tr class="text-center">
                                   <td class="border border-gray-200 p-[10px] space-y-2">
                                       ...
                                       <?php if(!empty($passCheck)): ?>
                                       <img src="<?php echo e(asset('frontend/img/icon-smile.png')); ?>" alt="" style="width: 60px;" class="inline-block">
                                       <p class="pt-[12px]">Chúc mừng bạn đã vượt qua bài thi này!</p>
                                       <?php else: ?>
                                       <img src="<?php echo e(asset('frontend/img/icon-un-smile.png')); ?>" alt="" style="width: 60px;" class="inline-block">
                               ...
                               <tr>
                                   <td class="border border-gray-200 p-[10px] text-center">
                                       <span class="bold-1 pr-[15px]">Số câu đúng</span><?php echo e($true); ?>/<?php echo e($count); ?> (<?php echo e((int)$pass); ?>%)
                                   </td>
                               </tr>

                               <tr>
                                   <td class="border border-gray-200 p-[10px] text-center">
                                       <span class="bold-1 pr-[15px]">Thời gian làm bài</span><?php echo e($timer); ?>

                                   </td>
                               </tr>
                               <tr>
                                   <td class="border border-gray-200 p-[10px] text-center">
                                       <span class="bold-1 pr-[15px]">Số lần tạm dừng</span><?php echo e($success->pause); ?>

                                   </td>
                               </tr>
                               <tr>
                                   <td class="border border-gray-200 p-[10px] text-center">
                                       <span class="bold-1 pr-[15px]">Ngày </span> <?php echo e($success->created_at); ?>
...
<?php echo $__env->make('homepage.layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\chuan.local\resources\views/quiz/frontend/quiz/success.blade.php ENDPATH**/ ?>
                            ...
                            <?php } else if ($item == 'json') { ?>
                                ...
                                <div class="mt-3">
                                    ...
                                    <div class="space-y-2 listJsonChildItems">
                                        <?php if(!empty($jsonChild[$k])): ?>
                                        <?php if(gettype($jsonChild[$k]) == 'string'): ?>
                                        <div class="flex relative"><input type="text" value="<?php echo e($jsonChild[$k]); ?>" name="<?php echo $name ?>[<?php echo $listType['keyword'][$key] ?>][<?php echo $i; ?>][]" class="w-full"><button type="button" class="btn btn-danger text-white absolute right-0 top-1/2 handleMinusItem" style="top: 50%;transform: translateY(-50%);width: 50px;height: 38px;display: flex;justify-content: center;align-items: center;">-</button></div>
                                        <?php else: ?>
                                        <?php $__currentLoopData = $jsonChild[$k]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="flex relative"><input type="text" value="<?php echo e($l); ?>" name="<?php echo $name ?>[<?php echo $listType['keyword'][$key] ?>][<?php echo $i; ?>][]" class="w-full"><button type="button" class="btn btn-danger text-white absolute right-0 top-1/2 handleMinusItem" style="top: 50%;transform: translateY(-50%);width: 50px;height: 38px;display: flex;justify-content: center;align-items: center;">-</button></div>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/catdailoc/domains/daicatloc.nhathuocdaicatloc.vn/public_html/resources/views/components/field/json.blade.php ENDPATH**/ ?>
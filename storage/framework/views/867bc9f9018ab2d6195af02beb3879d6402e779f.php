                    ...
                    <tr class="odd " id="post-<?php echo $v->id; ?>">
                        ...
                        <td class="w-40">
                            <div class="form-check form-switch">
                                <input <?php echo ($v->ishot == 1) ? 'checked=""' : ''; ?> class="form-check-input publish-ajax" type="checkbox" data-module="<?php echo e($module); ?>" data-id="<?php echo $v->id; ?>" data-title="ishot" id="ishot-<?php echo $v->id; ?>">
                            </div>
                        </td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ungbuou/domains/ungbuou.tamphat.edu.vn/public_html/resources/views/article/backend/category/index.blade.php ENDPATH**/ ?>
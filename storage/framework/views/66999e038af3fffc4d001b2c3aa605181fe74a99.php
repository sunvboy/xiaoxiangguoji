...
<div class="content">
    ...
    <form class="grid grid-cols-12 gap-6 mt-5" role="form" action="<?php echo e(route('category_media.store')); ?>" method="post" enctype="multipart/form-data">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ungbuou/domains/ungbuou.tamphat.edu.vn/public_html/resources/views/media/backend/category/create.blade.php ENDPATH**/ ?>
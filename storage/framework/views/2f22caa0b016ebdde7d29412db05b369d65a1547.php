                    ...
                    <div class="col-md-9 col-sm-9 col-12">
                        <div class="content-detail-left bg-white">
                            ...
                            <div class="date-view">
                                <ul>
                                    <li>
                                        <i class="fa fa-calendar-o" aria-hidden="true"></i> Ngày đăng: <?php echo e(\Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $detail->created_at)->format('d/m/Y')); ?>
            ...
            <div class="other-new bg-white">
                ...
                <div class="slider-new owl-carousel owl-loaded owl-drag">
                    ...
                    <div class="item">
                        ...
                        <p class="date"><i class="fa fa-calendar" aria-hidden="true"></i>Ngày đăng: <?php echo e(\Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $v->created_at)->format('d/m/Y')); ?></p>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('homepage.layout.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/catdailoc/domains/daicatloc.nhathuocdaicatloc.vn/public_html/resources/views/article/frontend/article/index.blade.php ENDPATH**/ ?>
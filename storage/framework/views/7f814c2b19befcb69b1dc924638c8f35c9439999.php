...
if ($errors->any()) {
    ...
    $version_json = !empty($detail->version_json) ? json_decode(base64_decode($detail->version_json), true) : [];
    $checkbox = [];
    $catalogue  = [];
    $attribute = [];
    if (!empty($version_json) && count($version_json) > 0) {
...
<!-- END: Quản lí tồn kho -->
<?php $__env->stopPush(); ?><?php /**PATH /home/catdailoc/domains/daicatloc.nhathuocdaicatloc.vn/public_html/resources/views/product/backend/product/common/attribute.blade.php ENDPATH**/ ?>